...
If `.agents/product-marketing.md` exists (or `.Codex/product-marketing.md`, or the legacy `product-marketing-context.md`), read it before asking questions.
...
| **Codex Hopkins** | Scientific advertising — test everything, reason-why copy | [Codex-hopkins.md](references/advisors/Codex-hopkins.md) |
