...
```bash
Codex-seo run google_auth.py --check --json
```
...
**Script:** `Codex-seo run pagespeed_check.py <url> --json`
...
**Script:** `Codex-seo run gsc_query.py --property <property> --json`
...
**Script:** `Codex-seo run gsc_inspect.py <url> --json`
...
**Script:** `Codex-seo run gsc_inspect.py --batch <file> --json`
...
**Script:** `Codex-seo run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `Codex-seo run indexing_notify.py <url> --json`
...
**Script:** `Codex-seo run indexing_notify.py --batch <file> --json`
...
**Script:** `Codex-seo run ga4_report.py --property <id> --json`
...
**Script:** `Codex-seo run ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `Codex-seo run youtube_search.py search "<query>" --json`
...
**Script:** `Codex-seo run youtube_search.py video <video_id> --json`
...
**Script:** `Codex-seo run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `Codex-seo run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `Codex-seo run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `Codex-seo run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `Codex-seo run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `Codex-seo run pagespeed_check.py <url> --json > data.json`
3. Generate report: `Codex-seo run google_report.py --type cwv-audit --data data.json --domain <domain>`
