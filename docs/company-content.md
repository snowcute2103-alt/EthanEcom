# Company Content — Ethan Ecom

> Content data (source of truth). `@`-reference this file when building any section that needs real company info.
> Nguồn: https://ethanecom.com/ + **"Bộ câu hỏi phỏng vấn ban lãnh đạo"** (Google Docs) — nội dung thật đã xác nhận bởi ban lãnh đạo.

**Quy tắc phân loại nội dung từ tài liệu phỏng vấn (bắt buộc):**
- 🟩 **Highlight XANH** = nội dung nhấn mạnh đặc biệt → đưa lên web VÀ làm nổi bật (hero, quote lớn, callout).
- ⬜ **Highlight XÁM** hoặc tag 🏷️ **[Đối ngoại]** / **[Cả hai]** = đưa lên web (thể hiện bình thường).
- ❌ Tag **[Đối nội]** không highlight = KHÔNG đưa lên web (chỉ nội bộ: số máy xưởng, công suất, P&L, SOP, lương từng vị trí, công cụ nội bộ…).
...
**Form ứng tuyển:** đính kèm file (PDF/DOC); tiêu đề theo cú pháp `[Tên Vị Trí] - [Họ và Tên]`; email nhận CV **hr@ethanecom.com**.
